            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="usuarios.jsp"><i class="fa fa-user fa-fw"></i> Usuarios</a>
                        </li>
                        <li>
                            <a href="cursos.jsp"><i class="fa fa-graduation-cap fa-fw"></i> Cursos</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a href="add_user.jsp"><i class="fa fa-plus fa-fw"></i> Añadir Usuario</a>
                                        </li>
